...
static double mover = -60;
static bool separado = false;
void

salida_trazo(GLfloat x, GLfloat y, char* format, ...)
{
	va_list args;
	char buffer[200], * p;
...
void doInit() {
	...
	/* Seleccione la matriz de proyección y reiníciela luego
       configurar nuestra perspectiva de vista */

	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
	gluPerspective(30.0f, (GLfloat)640 / (GLfloat)480, 0.1f, 200.0f);

	/* Seleccione la matriz de vista de modelo, que modificamos con rotarf() */
...
int main(int argc, char* argv[])
{
	...
	glutAddMenuEntry("Lanzamiento  'p '", 1);

	glutAddMenuEntry(" Abandonar  ' q'", 5);
